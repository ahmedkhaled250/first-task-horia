...
const { baseUrl } = useContext(UserContext);
  ...
  async function register(values) {
    setIsLoading(true);
    const { userName, email, password, cPassword, address, phone, personalId } =
      values;
  ...
  const handleFileChange = (event) => {
    ...
    formik.setFieldValue("personalId", file);
  };
            ...
            >
              ...
              <div className="w-full">
                ...
                >
                  ...
                  {formik.values.personalId?.name && (
                    <div className="w-10">
                      <PreviewImage file={formik.values.personalId} />
                    </div>
                  )}
                </label>
